...
VirtualJoystick.prototype._onMove	= function(x, y)
{
	if( this._pressed === true ){
		...
		if (this.controllerType == 'movement') {
			g_Player.keyState[69] = this.right();
			g_Player.keyState[81] = this.left();
			g_Player.keyState[87] = this.up();
			g_Player.keyState[83] = this.down();
		}
...
VirtualJoystick.prototype._onTouchEnd	= function(event)
{
	...
	if (this.controllerType == 'movement') {
		g_Player.keyState[69] = false;
		g_Player.keyState[81] = false;
		g_Player.keyState[87] = false;
		g_Player.keyState[83] = false;
	}
